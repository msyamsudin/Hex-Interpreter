...
// FIX: Added optional title prop to allow passing a title for tooltips, fixing a type error in DataInspector.tsx.
...
export const LoadingIcon = ({ className, title }: { className?: string, title?: string }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        fill="none"
...
// FIX: Added optional title prop to allow passing a title for tooltips, fixing a type error in DataInspector.tsx.
export const AlertTriangleIcon = ({ className, title }: { className?: string, title?: string }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
